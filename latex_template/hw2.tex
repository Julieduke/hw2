...
\newcommand{\outDate}{Wednesday, September 3}
\newcommand{\dueDate}{Monday, September 15}
\newcommand{\taNames}{Mihir, Aneesha, Alan, Annie, Neural the Narwhal}


\newcommand{\homeworktype}{\string written+prog}
\newcommand{\exitPollLink}{\string https://google.com}
...
%\begin{questions}
    ...
    \part[1] In this example, why is $c^*$ not directly knowable in practice?  
